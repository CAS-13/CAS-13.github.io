...
function init() {
  ...
  var streetTiles = L.tileLayer("https://cas-13.github.io/portfolio/tiles/STLBasemap/{z}/{x}/{y}.png");
  

  // create Wards tile layer and add it to map
  wardLabelTiles = L.tileLayer('https://cas-13.github.io/portfolio/tiles/WardLabelTiles/{z}/{x}/{y}.png');
